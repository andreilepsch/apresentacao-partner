  ...
  const newsArticles = [
    {
      ...
      subtitle: "Pedro Ros, CEO da Referência Partner, fala sobre movimentação no setor imobiliário",
      description: "Em conversa com GLOBO, Pedro Ros, CEO da Referência Partner, explica que por muito tempo o setor foi visto como uma opção de baixo retorno comparado a outras oportunidades de investimento. Entretanto, a percepção mudou nos últimos anos.",
      source: "O GLOBO",
      date: "Janeiro 2025",
