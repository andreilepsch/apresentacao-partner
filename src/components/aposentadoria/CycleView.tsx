...
const CycleView = ({ currentCycle, cycleNumber, totalCycles, monthlyInvestment, formatCurrency, onAdvance, onBack }: CycleViewProps) => {
  return (
    <div className="min-h-screen bg-[#F9FAFB] font-manrope">
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          {/* Progress Bar */}
          <ProgressBar currentStep={cycleNumber} totalSteps={totalCycles} />
          ...
          <div className="text-center mb-8">
            ...
            >
              {cycleNumber < totalCycles ? `Avançar para Ciclo ${cycleNumber + 1}` : 'Ver Projeção de Aposentadoria'}
            </RCButton>
          </div>
