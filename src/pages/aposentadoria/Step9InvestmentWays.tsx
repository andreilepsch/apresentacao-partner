...
const AposentadoriaStep9 = () => {
  ...
  const handlePrevious = () => {
    if (showComparison) {
      ...
      navigateWithPreview("/aposentadoria/step8");
    }
  };

  const handleFinalize = () => {
    navigateWithPreview("/aposentadoria/step10");
  };
      ...
      <div className="container mx-auto px-4 py-12 max-w-[1140px]">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-[16px] font-normal text-[#333333] mb-6 max-w-4xl mx-auto leading-relaxed">
            Comparativo entre as opções de investimento para sua aposentadoria
          </p>
...
export default AposentadoriaStep9;
