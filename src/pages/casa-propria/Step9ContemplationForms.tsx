      ...
      <div className="container mx-auto px-4 py-12 max-w-[1140px]">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-[#F7F5F0] rounded-xl p-8 text-center">
            <h3 className="text-2xl font-bold text-[#193D32] mb-4">
              Estratégia é fundamental
            </h3>
            <p className="text-[#333333] leading-relaxed">
              A escolha do grupo certo e o entendimento das formas de contemplação 
              são essenciais para o sucesso na estratégia de consórcio imobiliário.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-between items-center">
          ...
          <Button
            onClick={() => navigateWithPreview("/casa-propria/step10")}
...
export default CasaPropriaStep9;