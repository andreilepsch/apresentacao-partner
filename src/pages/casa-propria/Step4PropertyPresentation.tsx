...
import PropertyHighlight from "@/components/renda-extra/PropertyHighlight";
    ...
    <div className="min-h-screen bg-white font-manrope">
      <div className="container mx-auto px-4 py-12 max-w-[1140px]">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-between items-center">
          <Button
            variant="outline"
            onClick={() => navigateWithPreview("/casa-propria/step2")}
...
export default CasaPropriaStep4;
