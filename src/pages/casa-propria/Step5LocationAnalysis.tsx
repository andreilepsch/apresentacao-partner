...
import LocationMap from "@/components/renda-extra/LocationMap";
    ...
    <div className="min-h-screen bg-white font-manrope">
      <div className="container mx-auto px-4 py-12 max-w-[1140px]">
        ...
        <div className="max-w-6xl mx-auto mb-12">
          <LocationMap 
            mapImage="/lovable-uploads/ff2e05c7-4fcc-4474-a624-a6b16cbc2fd9.png"
            mapAlt="Mapa de Domingos de Moraes com pontos de interesse"
          />
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-between items-center">
          <Button
            variant="outline"
            onClick={() => navigateWithPreview("/casa-propria/step4")}
...
export default CasaPropriaStep5;
